"""
Django settings for misty_field_dev_103188 project.
...
ROOT_URLCONF = 'misty_field_dev_103188.urls'
...
WSGI_APPLICATION = 'misty_field_dev_103188.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_field_dev_103188 API",
    "DESCRIPTION": "API documentation for misty_field_dev_103188 App",
    "VERSION": "v1",
}
